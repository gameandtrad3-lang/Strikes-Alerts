...
export default function App(){
  ...
  const ticker=[...TICKER,...TICKER].join(" Â· ");
    ...
    React.createElement("div",{style:{minHeight:"100vh",display:"flex",flexDirection:"column"}},
      React.createElement("header",{style:{background:"var(--sf)",borderBottom:"1px solid var(--bd)",padding:"0 24px",height:56,display:"flex",alignItems:"center",justifyContent:"space-between"}},
        React.createElement("div",{style:{display:"flex",alignItems:"center",gap:12}},
          React.createElement("div",{style:{width:34,height:34,borderRadius:6,background:"linear-gradient(135deg,#c0143c,#ff4d6d)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,color:"#fff"}},"â"),
      ...
      React.createElement("div",{style:{display:"flex",gap:10,padding:"14px 24px",background:"var(--sf)",borderBottom:"1px solid var(--bd)",overflowX:"auto"}},
        ...[{l:"ACTIVE STRIKES",v:"2",s:"Genesys + Kaiser",c:"var(--gn)",d:0},{l:"AUTHORIZED",v:"3",s:"Corewell Â· BMC Â· OHSU",c:"var(--rd)",d:60},{l:"VOTES PENDING",v:"1",s:"Brattleboro Mar 23",c:"var(--or)",d:120},{l:"RNs AT RISK",v:"12.7K+",s:"Corewell = 10,000",c:"var(--yw)",d:180},{l:"TOP WEEKLY PAY",v:"$12,800",s:"2026 NYC benchmark",c:"var(--ac)",d:240}].map(x=>
      ...
      React.createElement("div",{style:{display:"flex",padding:"0 24px",background:"var(--sf)",borderBottom:"1px solid var(--bd)",overflowX:"auto"}},
        ...[{id:"strikes",l:"Strike Notices",n:STRIKES.length},{id:"contracts",l:"High-Pay Contracts",n:CONTRACTS.filter(c=>c.type!=="CLOSED").length},{id:"outlook",l:"Outlook",n:null},{id:"insights",l:"Market Intel",n:null},{id:"pricing",l:"ð³ Pricing",n:null}].map(t=>
      ...
      React.createElement("main",{style:{flex:1,padding:"24px",maxWidth:1100,width:"100%",margin:"0 auto"}},
        tab==="strikes"&&React.createElement("div",null,
          React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:18,flexWrap:"wrap",gap:10}},
            React.createElement("h2",{style:{fontFamily:"var(--fs)",fontSize:13,fontWeight:700,letterSpacing:2,textTransform:"uppercase",color:"var(--t2)"}},"ð¨ Active Disputes & Strike Notices"),
              ...
              return React.createElement("div",{key:s.id,onClick:()=>click(s),style:{background:isSel?"var(--p2)":"var(--pn)",border:`1px solid ${isSel?bc:"var(--bd)"}`,borderLeft:`3px solid ${bc}`,borderRadius:6,padding:"16px 18px",cursor:"pointer",animation:"fadeUp .45s ease both",animationDelay:`${i*60}ms`}},
                React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:12,marginBottom:10}},
                  React.createElement("div",null,
                    ...
                    React.createElement("div",{style:{fontFamily:"var(--fm)",fontSize:11,color:"var(--t2)"}},s.city,", ",s.state," Â· ",s.union)),
          ...
          React.createElement("div",{style:{marginTop:14,padding:"10px 14px",background:"var(--pn)",border:"1px solid var(--bd)",borderRadius:6,fontFamily:"var(--fm)",fontSize:10,color:"var(--mt)"}},"â¸ Tap any card to expand Â· Sources: NNU, NYSNA, Teamsters, CNA, Nurse.org")),
        tab==="contracts"&&React.createElement("div",null,
          React.createElement("h2",{style:{fontFamily:"var(--fs)",fontSize:13,fontWeight:700,letterSpacing:2,textTransform:"uppercase",color:"var(--t2)",marginBottom:18}},"ð° High-Pay Strike & Crisis RN Contracts"),
          React.createElement("div",{style:{background:"rgba(255,77,109,.12)",border:"1px solid rgba(255,77,109,.3)",borderRadius:6,padding:"10px 14px",marginBottom:18,fontFamily:"var(--fm)",fontSize:11,color:"var(--rd)"}},"â¡ ALERT: Corewell Health East 10K RNs SE Michigan â pre-position NOW before 10-day notice drops."),
          React.createElement("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(320px,1fr))",gap:12}},
            ...CONTRACTS.map((c,i)=>{
              ...
              return React.createElement("div",{key:c.id,style:{background:"var(--pn)",border:`1px solid ${c.hot?"var(--rd)":"var(--bd)"}`,borderRadius:6,padding:"16px 18px",animation:"fadeUp .45s ease both",animationDelay:`${i*70}ms`,position:"relative",overflow:"hidden",opacity:c.type==="CLOSED"?.55:1}},
                c.hot&&React.createElement("div",{style:{position:"absolute",top:0,right:0,background:"var(--rd)",color:"#fff",fontFamily:"var(--fm)",fontSize:9,fontWeight:700,letterSpacing:1,padding:"3px 10px",borderBottomLeftRadius:6}},"â¡ ACT NOW"),
        ...
        tab==="outlook"&&React.createElement("div",null,
          React.createElement("h2",{style:{fontFamily:"var(--fs)",fontSize:13,fontWeight:700,letterSpacing:2,textTransform:"uppercase",color:"var(--t2)",marginBottom:18}},"ð 2-4 Week Strike Outlook"),
          ...
          React.createElement("div",{style:{marginTop:14,padding:"12px 16px",background:"rgba(255,214,10,.12)",border:"1px solid rgba(255,214,10,.25)",borderRadius:6,fontFamily:"var(--fm)",fontSize:11,color:"var(--yw)"}},"â  NEXT: Brattleboro vote Mar 23 Â· Corewell 10-day notice (watch daily)")),
        tab==="insights"&&React.createElement("div",null,
          React.createElement("h2",{style:{fontFamily:"var(--fs)",fontSize:13,fontWeight:700,letterSpacing:2,textTransform:"uppercase",color:"var(--t2)",marginBottom:18}},"â¡ Market Intelligence"),
          React.createElement("div",{style:{display:"flex",flexDirection:"column",gap:10}},
            ...[{icon:"â¡",title:"Michigan is the #1 Deployment Zone",body:"Corewell (10K RNs, 9 hospitals) has 90% strike authorization. Genesys is Day 200. Pre-position with Fastaff, Aya, USNursing now.",color:"#ff4d6d"},{icon:"ð°",title:"2026 Pay Benchmarks Reset Upward",body:"NYC strike saw $161/hr and $12,800/week. Kaiser hit $9K/week. These anchor all future deployments.",color:"#39d353"},{icon:"ð§ ",title:"Psych/Behavioral Health: Hidden Niche",body:"25% surge in psych contracts 2026. NUHW Kaiser dispute drives sustained demand.",color:"#00e5ff"},{icon:"ð¤",title:"AI Clauses Now Standard",body:"Every major 2026 contract includes AI protection language. Expect more disputes as AI adoption accelerates.",color:"#ffd60a"},{icon:"ð",title:"First Contracts = Highest Risk",body:"Corewell and BMC South are first-contract disputes â most contentious type. Escalate faster, resolve slower.",color:"#ff8c42"}].map((item,i)=>
              ...
              return React.createElement("div",{key:p.id,style:{background:p.hi?"var(--p2)":"var(--pn)",border:`2px solid ${p.hi?"var(--ac)":"var(--bd)"}`,borderRadius:10,padding:"24px",position:"relative",boxShadow:p.hi?"0 0 40px rgba(0,229,255,.08)":"none"}},
                ...
                React.createElement("div",{style:{display:"flex",flexDirection:"column",gap:10,marginBottom:24}},
                  ...p.features.map(f=>React.createElement("div",{key:f,style:{display:"flex",alignItems:"flex-start",gap:8}},
                    React.createElement("span",{style:{color:"var(--gn)",fontFamily:"var(--fm)",fontSize:12,flexShrink:0}},"â"),
      ...
      React.createElement("footer",{style:{background:"var(--sf)",borderTop:"1px solid var(--bd)",padding:"10px 24px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:6}},
        React.createElement("div",{style:{fontFamily:"var(--fm)",fontSize:10,color:"var(--mt)"}},"StrikeIntel Â· Healthcare Labor Intelligence Â· Not legal or financial advice"),
        React.createElement("div",{style:{fontFamily:"var(--fm)",fontSize:10,color:"var(--mt)"}},"Scan: 6-12hr Â· Powered by Claude AI"))));
}