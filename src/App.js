...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
const STRIKES = [
  ...
  },
  {
    ...
    date: "Results: Mar 23 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Strike ~Apr 2",
  ...
  },
  {
    ...
    date: "~Day 200 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ongoing",
...
const CONTRACTS = [
  {
    ...
    pay_hr: "$80ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ130/hr", pay_wk: "$4,800ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ7,800/wk (est.)",
    type: "STRIKE", specialty: ["ICU", "L&D", "ER"],
    start: "Imminent ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Corewell",
    agency: "Fastaff ÃÂÃÂÃÂÃÂ· Aya ÃÂÃÂÃÂÃÂ· USNursing",
    hot: true,
    note: "Pre-position NOW before 10-day notice drops and slots vanish",
  },
  {
    id: 2,
    title: "Strike RN ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ All Specialties",
    location: "Grand Blanc, MI",
    pay_hr: "$90ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ120/hr", pay_wk: "$5,400ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ7,200/wk",
    type: "STRIKE", specialty: ["Med-Surg", "ICU", "ER"],
    start: "Active now",
    agency: "USNursing ÃÂÃÂÃÂÃÂ· Cross Country",
    hot: false,
    note: "Henry Ford Genesys ~Day 200. Volume tapering ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ act fast",
  },
  {
    id: 3,
    title: "Crisis RN ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Behavioral Health",
    location: "Northern California",
    pay_hr: "$95ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ115/hr", pay_wk: "$5,700ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ6,900/wk",
    type: "CRISIS", specialty: ["Psych", "Behavioral Health"],
    start: "Now",
    agency: "Aya ÃÂÃÂÃÂÃÂ· Vivian ÃÂÃÂÃÂÃÂ· Fastaff",
    hot: false,
  ...
  },
  {
    ...
    pay_hr: "$70ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ95/hr", pay_wk: "$4,200ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ5,700/wk (est.)",
    type: "PRE-POSITION", specialty: ["Med-Surg", "ER", "ICU"],
    start: "~Apr 2 if strike authorized",
    agency: "Fastaff ÃÂÃÂÃÂÃÂ· White Glove",
    hot: true,
    note: "Small hospital (160 RNs). Fast fill. Register before Mar 23 vote results.",
  },
  {
    id: 5,
    title: "Strike RN ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ NYC Benchmark (Closed)",
    location: "New York City, NY",
    pay_hr: "Up to $161/hr (peak)", pay_wk: "$10,500ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ$12,800/wk",
...
const TICKER_ITEMS = [
  "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ´ COREWELL HEALTH EAST MI ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 10,000 RNs authorize strike ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 10-day notice IMMINENT",
  "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ  BRATTLEBORO MEMORIAL VT ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Strike vote results due MON MAR 23",
  "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ KAISER UNAC/UHCP ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Contracts RATIFIED Mar 20 ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 31,000 workers return",
  "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ NYC NYSNA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Strike ended Feb 21 after 41 days ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ all contracts ratified",
  "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¡ HENRY FORD GENESYS MI ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Day ~200 of strike ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 'optimistic' joint statement",
  "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂµ NUHW KAISER MENTAL HEALTH CA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Active strike ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 23K CNA sympathy Mar 18",
  "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ 2026 BENCHMARK: Strike RNs earned up to $161/hr ÃÂÃÂÃÂÃÂ· $12,800/wk NYC window",
  "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¡ MICHIGAN = #1 DEPLOYMENT ZONE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Corewell + Genesys dual flashpoint",
];
...
const INSIGHTS = [
  { icon: "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¡", title: "Michigan is the #1 Deployment Zone", body: "Corewell Health East (10K RNs, 9 hospitals) has a 90% strike authorization vote and no final offer. Henry Ford Genesys is 200 days in. Pre-position credentials with Fastaff, Aya, and USNursing immediately.", color: "var(--red)" },
  { icon: "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ°", title: "2026 Crisis Pay Benchmarks Reset Upward", body: "NYC strike saw rates up to $161/hr and $12,800/week. Kaiser crisis hit $9K/week. These numbers anchor expectations for every future deployment.", color: "var(--green)" },
  { icon: "ÃÂÃÂ°ÃÂÃÂÃÂÃÂ§ÃÂÃÂ ", title: "Psych/Behavioral Health: Hidden High-Pay Niche", body: "25% surge in psych contract offers in 2026. The NUHW Kaiser mental health dispute signals sustained demand. If you hold a psych cert, this market is underserved and growing fast.", color: "var(--accent)" },
  { icon: "ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¤ÃÂÃÂ", title: "AI Clauses Are Now Standard Bargaining Demands", body: "Every major 2026 contract now includes language blocking AI from replacing clinical judgment. This structural conflict will drive more disputes as hospital AI adoption accelerates.", color: "var(--yellow)" },
  { icon: "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ", title: "First Contracts = Highest Escalation Risk", body: "Corewell and BMC South are first-contract disputes ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ historically the most contentious type. These escalate faster and resolve slower than renewals.", color: "var(--orange)" },
];

// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ TRAVEL CONTRACTS DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ PRICING DATA ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
const PLANS = [
  {
    ...
    features: [
      ...
      "2ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ4 week strike outlook",
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ COMPONENTS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
function Ticker() {
  const full = [...TICKER_ITEMS, ...TICKER_ITEMS].join("     ÃÂÃÂÃÂÃÂ·     ");
  return (
    ...
    <div onClick={() => onClick(s)} style={{ background: selected ? "var(--panel2)" : "var(--surface)", border: `1px solid ${selected ? statusColor : "var(--border)"}`, borderLeft: `6px solid ${statusColor}`, borderRadius: 8, padding: "16px 18px", cursor: "pointer", animation: `fadeUp 0.45s ease both`, animationDelay: `${idx * 60}ms`, transition: "all 0.15s", boxShadow: selected ? `0 2px 12px ${statusColor}22` : "0 1px 3px rgba(0,0,0,0.04)" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12, marginBottom: 10 }}>
        <div>
          ...
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 13, color: "var(--text2)" }}>{s.city}, {s.state} ÃÂÃÂÃÂÃÂ· {s.union}</div>
        </div>
...
function ContractCard({ c, idx }) {
  ...
  return (
    <div style={{ background: "var(--panel)", border: `1px solid ${c.hot ? "var(--red)" : "var(--border)"}`, borderRadius: 6, padding: "16px 18px", animation: `fadeUp 0.45s ease both`, animationDelay: `${idx * 70}ms`, position: "relative", overflow: "hidden", opacity: c.type === "CLOSED" ? 0.55 : 1 }}>
      {c.hot && <div style={{ position: "absolute", top: 0, right: 0, background: "var(--red)", color: "#fff", fontFamily: "var(--font-mono)", fontSize: 9, fontWeight: 700, letterSpacing: 1, padding: "3px 10px", borderBottomLeftRadius: 6 }}>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¡ ACT NOW</div>}
      ...
      <div style={{ background: c.hot ? "var(--red-dim)" : "rgba(255,255,255,0.03)", border: `1px solid ${c.hot ? "var(--red)44" : "var(--border)"}`, borderRadius: 4, padding: "7px 10px", fontFamily: "var(--font-mono)", fontSize: 10, color: c.hot ? "var(--red)" : "var(--text2)" }}>
        ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ {c.note}
      </div>
    </div>
  );
}
...
function PricingPage() {
  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto" }}>
      <SectionHeader accent="var(--accent)">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ³ Plans & Pricing</SectionHeader>
      ...
      <div style={{ background: "var(--panel)", border: "1px solid var(--border)", borderRadius: 8, padding: "20px 24px", marginBottom: 28, textAlign: "center" }}>
        ...
        <div style={{ fontFamily: "var(--font-sans)", fontSize: 14, color: "var(--text2)" }}>
          Strike nurses earn $5,000ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ$12,800/week. At $14.99/mo, your subscription pays for itself in the first 30 minutes on assignment.
        </div>
      </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 24 }}>
                {plan.features.map(f => (
                  <div key={f} style={{ display: "flex", alignItems: "flex-start", gap: 8 }}>
                    <span style={{ color: "var(--green)", fontFamily: "var(--font-mono)", fontSize: 12, flexShrink: 0, marginTop: 1 }}>ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ</span>
      ...
      <div style={{ background: "var(--panel)", border: "1px solid var(--border)", borderRadius: 8, padding: "20px 24px" }}>
        ...
        {[
          { q: "How often is the data updated?", a: "Intel is scanned and refreshed every 6ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ12 hours, and on-demand when major notices drop." },
        ...
        <div style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "var(--muted)" }}>Payments powered by Stripe ÃÂÃÂÃÂÃÂ· SSL secured ÃÂÃÂÃÂÃÂ· Cancel anytime</div>
      </div>
    </div>
  );
}

// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ TRAVEL CONTRACTS PAGE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
      ...
      <div style={{ background: D.surface, borderBottom: `1px solid ${D.border}`, padding: "16px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ fontSize: 22, fontWeight: 800, color: D.text, marginBottom: 4 }}>
            ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¥ Travel Nurse Contract Assignments
          </div>
          <div style={{ fontSize: 13, color: D.text2 }}>
            Latest travel nurse openings by state, specialty & hospital ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ updated daily
          </div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px" }}>
          ...
          {filtered.map((c, i) => (
            <div key={c.id} style={{ background: D.surface, border: `1px solid ${c.hot ? D.accent : D.border}`, borderTop: `3px solid ${c.hot ? D.accent : D.border}`, borderRadius: 10, padding: "18px 20px", animation: `fadeUp 0.4s ease both`, animationDelay: `${i * 50}ms`, position: "relative", overflow: "hidden" }}>
              ...
              <button style={{ width: "100%", padding: "10px", background: c.hot ? D.accent : "transparent", border: `1px solid ${c.hot ? D.accent : D.border}`, color: c.hot ? "#000" : D.text, borderRadius: 8, fontFamily: "var(--font-sans)", fontSize: 13, fontWeight: 700, cursor: "pointer" }}>
                {c.hot ? "ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¡ Apply Now" : "View & Apply"}
              </button>
            </div>
          ))}
        </div>
        ...
        {filtered.length === 0 && (
          <div style={{ textAlign: "center", padding: "60px 20px", color: D.muted }}>
            <div style={{ fontSize: 40, marginBottom: 12 }}>ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ</div>
...
export default function App() {
  ...
  const TABS = [
    ...
    { id: "outlook",   label: "2ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ4 Wk Outlook",   count: null },
    { id: "insights",  label: "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° News",             count: null },
    { id: "pricing",   label: "ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ³ Pricing",        count: null },
  ];
      ...
      <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ background: "#ffffff", borderBottom: "2px solid var(--border)", display: "flex" }}>
          <button onClick={() => setMode("strikes")} style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 10, padding: "16px 24px", fontFamily: "var(--font-sans)", fontSize: 16, fontWeight: 700, cursor: "pointer", transition: "all 0.15s", border: "none", borderBottom: mode === "strikes" ? "3px solid #e53e5a" : "3px solid transparent", background: mode === "strikes" ? "#fff5f7" : "#ffffff", color: mode === "strikes" ? "#e53e5a" : "#94aabf", marginBottom: -2 }}>
            ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¨ Travel Strikes
          </button>
          ...
          <button onClick={() => setMode("contracts")} style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 10, padding: "16px 24px", fontFamily: "var(--font-sans)", fontSize: 16, fontWeight: 700, cursor: "pointer", transition: "all 0.15s", border: "none", borderBottom: mode === "contracts" ? "3px solid #0077aa" : "3px solid transparent", background: mode === "contracts" ? "#f0f8ff" : "#ffffff", color: mode === "contracts" ? "#0077aa" : "#94aabf", marginBottom: -2 }}>
            ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¼ Travel Contracts
          </button>
        </div>
        ...
        <header style={{ background: "var(--surface)", borderBottom: "1px solid var(--border)", padding: "0 24px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 1px 3px rgba(0,0,0,0.06)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 18, flexShrink: 0 }}>
            ...
            <div style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "var(--muted)" }}>
              {now.toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })} ÃÂÃÂÃÂÃÂ· {now.toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit" })}
            </div>
        ...
        <div style={{ display: "flex", gap: 10, padding: "14px 24px", background: "var(--surface)", borderBottom: "1px solid var(--border)", overflowX: "auto" }}>
          ...
          <StatCard label="AUTHORIZED" value="2" sub="Corewell ÃÂÃÂÃÂÃÂ· BMC South" color="var(--red)" delay={60} />
          <StatCard label="VOTES PENDING" value="1" sub="Brattleboro ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Mar 23" color="var(--orange)" delay={120} />
        ...
        <main style={{ flex: 1, padding: "24px", maxWidth: 1100, width: "100%", margin: "0 auto" }}>
          ...
          {tab === "strikes" && (
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18, flexWrap: "wrap", gap: 10 }}>
                <SectionHeader accent="var(--red)">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¨ Active Labor Disputes & Strike Notices</SectionHeader>
              ...
              <div style={{ marginTop: 14, padding: "10px 14px", background: "var(--panel)", border: "1px solid var(--border)", borderRadius: 6, fontFamily: "var(--font-mono)", fontSize: 10, color: "var(--muted)" }}>
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¸ Tap any card to expand ÃÂÃÂÃÂÃÂ· Sources: NNU, NYSNA, Teamsters, CNA, Nurse.org, local news
              </div>
            </div>
          )}
          ...
          {tab === "contracts" && (
            <div>
              <SectionHeader accent="var(--green)">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° High-Pay Strike & Crisis RN Contracts</SectionHeader>
              <div style={{ background: "var(--red-dim)", border: "1px solid rgba(255,77,109,0.3)", borderRadius: 6, padding: "10px 14px", marginBottom: 18, fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--red)", lineHeight: 1.6 }}>
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¡ ALERT: Corewell Health East (10K RNs, SE Michigan) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ pre-position NOW before 10-day notice drops.
              </div>
          ...
          {tab === "outlook" && (
            <div>
              <SectionHeader accent="var(--yellow)">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ 2ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ4 Week Strike Probability Outlook</SectionHeader>
              ...
              <div style={{ marginTop: 14, padding: "12px 16px", background: "var(--yellow-dim)", border: "1px solid rgba(255,214,10,0.25)", borderRadius: 6, fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--yellow)", lineHeight: 1.8 }}>
                ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ  NEXT TRIGGERS: Brattleboro vote results Mon Mar 23 ÃÂÃÂÃÂÃÂ· Corewell 10-day notice (watch daily) ÃÂÃÂÃÂÃÂ· Henry Ford Genesys resolution TBD
              </div>
            </div>
          )}
          ...
          {tab === "insights" && (
            <div>
              <SectionHeader accent="var(--accent)">ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ° Latest Strike News</SectionHeader>
              <div style={{ background: "var(--accent-dim)", border: "1px solid rgba(0,119,170,0.2)", borderRadius: 8, padding: "12px 16px", marginBottom: 18, fontFamily: "var(--font-sans)", fontSize: 13, color: "var(--accent)" }}>
                ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ News is updated daily at 6 AM ET ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ sourced from union announcements, local news, and healthcare publications.
              </div>
        ...
        <footer style={{ background: "var(--surface)", borderTop: "1px solid var(--border)", padding: "10px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 6 }}>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "var(--muted)" }}>StrikeIntel ÃÂÃÂÃÂÃÂ· Healthcare Labor Intelligence ÃÂÃÂÃÂÃÂ· Not legal or financial advice</div>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "var(--muted)" }}>Scan cycle: 6ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ12hr ÃÂÃÂÃÂÃÂ· Powered by Claude AI</div>
        </footer>
      </> )}
      </div>
    </>
